...
// Matrix3 but with values consisting of double instead of the high precision Double
// Operations on this matrix are faster but are less precise
// Usefull when doing calculations for rendering where the extra precision is not needed, but that
// may be called very often
class Matrix3double
{
public:
    double m[3][3];
